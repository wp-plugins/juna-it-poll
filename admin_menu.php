...
<form method="post" id="AdminForm" enctype="multipart/form-data" onsubmit="if(Validate()==false) return false;" >
		<div id = 'display_media_button'  >
			...
			<h2 id = 'h2_1'>Вставить медиафайл</h2>
				...
				<div  id= 'display_for_selected_file'>
					...
					<input type="file"   id="upload11" name = 'upload11' value = '' style = 'display:none;'/>
					<input type="file"   id="upload21" name = 'upload21'value = '' style = 'display:none ;' />
					<input type="file"   id="upload31" name = 'upload31' value = '' style = 'display:none ;'/>
					<input type="file"   id="upload41" name = 'upload41' value = '' style = 'display:none;'/>
					<input type="file"   id="upload51" name = 'upload51'value = '' style = 'display:none ;'/>
					<input type="file"   id="upload61" name = 'upload61' value = '' style = 'display:none ;'/>
					<input type="file"   id="upload71" name = 'upload71' value = '' style = 'display:none;'/>
					<input type="file"   id="upload81" name = 'upload81' value = '' style = 'display:none;'/>
					<input type="file"   id="upload91" name = 'upload91' value = '' style = 'display:none;'/>
					<input type="file"   id="upload101" name = 'upload101' value = '' style = 'display:none ;'/>
					...
					<div  id = 'select_file_library'>
						...
						<?php 
							if ($handle = opendir(plugin_dir_path( __FILE__).'Images/Uploads')) {
							     ...
							     while (false !== ($entry = readdir($handle))) {
					        		...
					        		$choice = end($img);
					        		//$j=explode('juna_',$img[0]);
					        		if(in_array($choice,$expansion)){
					        			
						        		echo "<img src = '".trim(plugins_url("Images/Uploads/" , __FILE__).$img[0].'.'.$choice )." 'class = 'image_select_file_library' />";
	...
	<fieldset style="position:relative; margin-bottom:15px;background-color: white;border-radius: 6px;width: 675px; height: 190px;box-shadow: 2px -2px 1px 1px #ddd;border: 2px double rgb(232, 232, 237);">

 		<legend id="spt"style='margin-left: 10px;color: #B0AFAF; font-size:16px;'><i> Select Plugin Type </i></legend> <input type="text"  id="img_id" name="img_name" style="display:none;" value="1"/> <br><br>
 	...
 	<fieldset id="shortcode_section"  style="position: absolute; top: 70px;margin-left: 695px; width:300px; height:170px; padding:10px; box-shadow: 2px -2px 1px 1px #ddd;border: 2px double rgb(232, 232, 237);border-radius:6px; background-color: white; padding: 10px;">
 		<legend style="color: #B0AFAF;font-size:16px;"><i>Shortcode</i></legend>
 	...
 	<fieldset id='question_section' style='background-color: white;border-radius: 6px;box-shadow: 2px -2px 1px 1px #ddd; width: 675px;border-radius:6px;border: 2px double rgb(232, 232, 237);'>

		<legend style="color: #B0AFAF;font-size:16px;"><i> Question</i> </legend>
	...
	<fieldset id='answers_section' style='width:656px;background-color:white;margin-top: 20px;border-radius:6px;padding: 10px;box-shadow: 2px -2px 1px 1px #ddd;border: 2px double rgb(232, 232, 237);'>	
		<legend style="color: #B0AFAF;font-size:16px;"><i> Answers</i> </legend>
		...
		<div id="Admin_Menu" style="position:relative; width:658px; height: 500px; margin-bottom: 20px; ">
			...
			<div style="position: absolute; right: 0; top: 0; width: 230px; height: 400px;">
				...
				<label id="labelUpload1" style="display:none; font-size:14px;  "> Include File</label>  
		 		...
		 		<!-- <input type="file" disabled="false"  id="upload1" style="display:none; padding: 0; height: 27px;" accept="image/*"/> --> 
	...
	<fieldset id='widget_section' style=' background-color:white;box-shadow: 2px -2px 1px 1px #ddd;border: 2px double rgb(232, 232, 237);border-radius:6px;margin-top: 10px;width: 655px;padding: 10px;'>
		<legend style="color: #B0AFAF;font-size:16px;"><i> Widget Style</i> </legend>
	 	...
	 	<div id="Color_Picker" style="position:relative; margin-top: 25px; width:400px;">
	 		...
	 		<input type="color"  id="vote_button_div" style="float:right; height: 23px; padding: 1px 3px;border-radius:3px;" onchange="ColorPicker('vote_button_color',true)"> 
	 		<input type="text" value="#000000" name="vote_button_color" id="vote_button_color" style="width: 170px; float:right; margin-right:10px;border-radius:3px;" onchange="ColorPicker('vote_button_color',false)"><br><br>
	 		 	
	 		<label style="font-size:14px;color: #B0AFAF;">Button`s Text Color:  </label>
	 		<input type="color" value="#ffffff" id="buttons_text_div" style="float:right; height: 23px; padding: 1px 3px;border-radius:3px;" onchange="ColorPicker('buttons_text_color',true)"> 
	 		<input type="text" value="#ffffff" name="buttons_text" id="buttons_text_color" style="width: 170px; float:right; margin-right:10px;border-radius:3px;" onchange="ColorPicker('buttons_text_color',false)"><br><br>
	 		 		 
	 		<label style='font-size:14px;color: #B0AFAF;'>Widget's width: </label> <input type="number" onchange='set()' name="widg_width" id="widg_width" min="250" value='250' style="margin-left:71px; width:80px;border-radius:3px;" /> <span> px </span> <br><br>		 
	 		...
	 		<input type="text" value="#ffffff" name="votes_color" id="votes_text_color" style="width: 170px; float:right; margin-right:10px;border-radius:3px;" onchange="ColorPicker('votes_color',false)">
	 	...
	 	<div style="position:relative; margin-top: 25px; width:448px;">
	 		...
	 		<label id="hoverColor_label" style="display:none; font-size:14px;color: #B0AFAF;">Hover Color: </label> 
			<input id="HoverCheck" type="checkbox"  style="float:right; opacity:0; height:20px; width:20px; margin-top:5px;border-radius:3px;" onchange="ActivateHover()">
			<input type="color"  disabled="true" id="colorPickerhover" style="display:none; float:right; margin-right: 25px; height: 23px; padding: 1px 3px;border-radius:3px; " onchange="ColorPicker('col_pick',true)">
			<input id="selectedHoverColor" disabled="true" type="text"   value="#000000" name="selectedHoverColor" style="border-radius:3px; margin-right:10px; display:none; width: 170px; float:right;border-radius:3px;" onchange="ColorPicker('col_pick',false)">
			

	 	</div>
	</fieldset>
 	<fieldset id='font_section'style='box-shadow: 2px -2px 1px 1px #ddd; background-color:white;border: 2px double rgb(232, 232, 237);border-radius:6px;margin-top: 10px;width: 655px;padding: 10px; height:150px;'>
 		<legend style="color: #B0AFAF;font-size:16px;"> <i>Fonts</i> </legend>
	 	<div id="fonts_div" style="position: relative; width: 600px; margin: 0 auto 0 0; ">
	 	
	 	<div style="float: left; width: 600px; height: 23px;">
	 	<label style='color: #B0AFAF;'> Select Text Font: </label>
	 	...
	 	<select name="Text_Font" id="Text_Font" onchange="ChangeFont('false');">
			...
			<option value='Vijaya'> Vijaya </option>
	 		...
	 		<label style="font-size:14px;color: #B0AFAF; " id="fontCheck">  Do You Like Our Plugin?  </label> 
	 	</div>
	 	<br> <br>
	 	<label style='color: #B0AFAF;'> Question's Font-Size: </label> <input type="number" min=12 max=20 name="fontSize" id="fontSize" value="14" style="margin-left:40px; width:50px;border-radius:3px;" onchange="ChangeFont('true');" /> <span> px </span> <br>
	 	</div>
 	</fieldset>
 	...
 	<div class='plugins_type' id='plugins_type1' style='padding:0 10px 0 10px; border: 1px solid #c0c0c0; position: absolute;top: 418px; width: 250px;left: 695px;border-radius:6px;background:#ffffff;'>
	 	
		 	<p class='questions_title'style='text-align:center;color:#c0c0c0;'>Question?</p>	
		 	<div class='votes1'><input class='radio' type='radio'style='float:left;' name="answer"><p class='set_answer' id='ans1' style="margin-left:20px;color:#c0c0c0;width:260px;height:20px;">Answer1</p></div>
		 	<div class='votes2'><input class='radio' type='radio'style='float:left;' name="answer"><p class='set_answer' id='ans2' style='margin-left:20px;color:#c0c0c0;width:260px;height:20px;'>Answer2</p></div>
		 	<div class='votes3' style='display:none;'><input class='radio' type='radio' style='float:left;' name="answer"><p class='set_answer' id='ans3' style='margin-left:20px;color:#c0c0c0;width:260px;height:20px;'>Answer3</p></div>
		 	<div class='votes4' style='display:none;'><input class='radio' type='radio' style='float:left;' name="answer"><p class='set_answer' id='ans4' style='margin-left:20px;color:#c0c0c0;width:260px;height:20px;'>Answer4</p></div>
		 	<div class='votes5' style='display:none;'><input class='radio' type='radio' style='float:left;' name="answer"><p class='set_answer' id='ans5' style='margin-left:20px;color:#c0c0c0;width:260px;height:20px;'>Answer5</p></div>
		 	<div class='votes6' style='display:none;'><input class='radio' type='radio' style='float:left;' name="answer"><p class='set_answer' id='ans6' style='margin-left:20px;color:#c0c0c0;width:260px;height:20px;'>Answer6</p></div>
		 	<div class='votes7' style='display:none;'><input class='radio' type='radio' style='float:left;' name="answer"><p class='set_answer' id='ans7' style='margin-left:20px;color:#c0c0c0;width:260px;height:20px;'>Answer7</p></div>
		 	<div class='votes8' style='display:none;'><input class='radio' type='radio' style='float:left;' name="answer"><p class='set_answer' id='ans8' style='margin-left:20px;color:#c0c0c0;width:260px;height:20px;'>Answer8</p></div>
		 	<div class='votes9' style='display:none;'><input class='radio' type='radio' style='float:left;' name="answer"><p class='set_answer' id='ans9' style='margin-left:20px;color:#c0c0c0;width:260px;height:20px;'>Answer9</p></div>
		 	<div class='votes10' style='display:none;'><input class='radio'type='radio' style='float:left;' name="answer"><p class='set_answer' id='ans10' style='margin-left:20px;color:#c0c0c0;width:260px;height:20px;'>Answer10</p></div>
		 	<input id='vote_button' type='button'value='Vote' style='background: #000000;width: 62px;color: #ffffff;margin-left: 109px; border-radius: 10px;'>
	 
 	</div>
 	<div class='plugins_type'id='plugins_type2'style='padding:0 10px 10px 10px; display:none;border: 1px solid gray; position: absolute;top: 418px; width: 250px;left: 695px;border-radius:20px;background:white;'>
 	...
 	<div class='plugins_type'id='plugins_type3'style=' display:none; position: absolute;top: 418px; width: 250px; left: 695px;border-radius:20px;background-color:#0080FF;padding:20px;'>
 		<p class='questions_title'style='text-align:center;color:#0080FF; background-color:white;margin:10px 10px 10px 10px;'>Question?</p>
 		<div id='set_file1' style='float:left; margin:5px 0 5px 10px;width:100px;border:1px solid white;padding:2px;'><div id='file1' style='background-color:gray;height:66px;'></div><p class='set_answer' id='set_answer1'style='text-align:center;color:white;'>Answer1</p></div>
 		<div id='set_file2' style='float:left;margin:5px 10px 5px 15px;width:100px;border:1px solid white;padding:2px;'><div id='file2' style='background-color:gray;height:66px;'></div><p class='set_answer'id='set_answer2'style='text-align:center;color:white;'>Answer2</p></div>
 		<div id='set_file3' style='display:none;float:left;margin:5px 0 5px 10px;width:100px;border:1px solid white;padding:2px;'><div id='file1' style='background-color:gray;height:66px;'></div><p class='set_answer'id='set_answer3'style='text-align:center;color:white;'>Answer3</p></div>
 		<div id='set_file4' style='display:none;float:left;margin:5px 10px 5px 15px;width:100px;border:1px solid white;padding:2px;'><div id='file2' style='background-color:gray;height:66px;'></div><p class='set_answer'id='set_answer4'style='text-align:center;color:white;'>Answer4</p></div>
 		<div id='set_file5' style='display:none;float:left;margin:5px 0 5px 10px;width:100px;border:1px solid white;padding:2px;'><div id='file1' style='background-color:gray;height:66px;'></div><p class='set_answer' id='set_answer1'style='text-align:center;color:white;'>Answer6</p></div>
 		<div id='set_file6' style='display:none;float:left;margin:5px 10px 5px 15px;width:100px;border:1px solid white;padding:2px;'><div id='file1' style='background-color:gray;height:66px;'></div><p class='set_answer' id='set_answer1'style='text-align:center;color:white;'>Answer6</p></div>
 		<div id='set_file7' style='display:none;float:left;margin:5px 0 5px 10px;width:100px;border:1px solid white;padding:2px;'><div id='file2' style='background-color:gray;height:66px;'></div><p class='set_answer'id='set_answer2'style='text-align:center;color:white;'>Answer7</p></div>
 		<div id='set_file8' style='display:none;float:left;margin:5px 10px 5px 15px;width:100px;border:1px solid white;padding:2px;'><div id='file1' style='background-color:gray;height:66px;'></div><p class='set_answer'id='set_answer3'style='text-align:center;color:white;'>Answer8</p></div>
 		<div id='set_file9' style='display:none;float:left;margin:5px 0 5px 10px;width:100px;border:1px solid white;padding:2px;'><div id='file2' style='background-color:gray;height:66px;'></div><p class='set_answer'id='set_answer4'style='text-align:center;color:white;'>Answer9</p></div>
 		<div id='set_file10' style='display:none;float:left;margin:5px 10px 5px 15px;width:100px;border:1px solid white;padding:2px;'><div id='file1' style='background-color:gray;height:66px;'></div><p class='set_answer'id='set_answer5'style='text-align:center;color:white;'>Answer10</p></div>
 	</div>
 	<div class='plugins_type' id='plugins_type4' style='padding:0 10px 10px 10px; display:none;border: 1px solid gray; position: absolute;top: 418px; width: 250px;left: 695px;border-radius:20px;background:white;'>
			...
			if($image==1)
			{
				...
				for($i=1; $i<=$k; $i++)
				{
					...
					//insert data to poll_wp_Settings
						...
						{	
						 	$wpdb->query($wpdb->prepare("INSERT INTO $table_name4 (id, border_color, bg_color, font_family, font_size, answer_color, answer_hover_color, question_color, vote_button_color, buttons_text_color, widget_div_width, vote_type, vote_color, QuestionID) VALUES (%d,%s,%s,%s,%d,%s,%s,%s,%s,%s,%s,%s,%s,%d)", '', $borderColor, $bgColor, $fontFamily, $fontSize, $answerColor, $answerHoverColor, $questionColor, $vote_button_color, $buttons_text, $widg_width, $type_vote, $votes_color, $count));
 						}
 						else
 						{
 							return false;
