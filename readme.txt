...
== Juna IT CSS ==
@import url('calmain.css');@font-face {  font-family: 'fontawesome-selected';  src: url("../font/fontawesome-selected.eot");  src: url("../font/fontawesome-selected.eot?#iefix") format('embedded-opentype'), url("../font/fontawesome-selected.woff") format('woff'), url("../font/fontawesome-selected.ttf") format('truetype'), url("../font/fontawesome-selected.svg#fontawesome-selected") format('svg');  font-weight: normal;  font-style: normal;}.fc-poll-container {	position: relative;	height: 400px;	width: 400px;}.fc- poll {	width: 90%;	height: 90%;}.fc- poll .fc-head {	height: 30px;	line-height: 30px;	/*background: #ccc;*/	/*color: #fff;*/}.fc- poll .fc-body {	position: relative;	width: 100%;	height: 100%;	height: -moz-calc(90% - 20px);	height: -webkit-calc(100% - 30px);	height: calc(100% - 30px);	border: 1px solid #ddd;}.fc- poll .fc-row {	width: 900%;	border-bottom: 1px solid #ddd;}.fc-four-rows .fc-row  {	height: 25%;}.fc-five-rows .fc-row  {	height: 20%;}.fc-six-rows .fc-row {	height: 16.66%;	height: -moz-calc(100%/6);	height: -webkit-calc(100%/6);	height: calc(100%/6);}.fc- poll .fc-row > div,.fc- poll .fc-head > div {	float: left;	height: 100%;	width:  14.28%; /* 100% / 7 */	width: -moz-calc(100%/7);	width: -webkit-calc(100%/7);	width: calc(100%/7);	position: relative;}/* IE 9 is rounding up the calc it seems */.ie9 .fc- poll .fc-row > div,.ie9 .fc- poll .fc-head > div {	width:  14.2%;}.fc- poll .fc-row > div {	border-right: 1px solid #ddd;	padding: 4px;	overflow: hidden;	position: relative;}.fc- poll .fc-head > div {	text-align: center;}.fc- poll .fc-row > div > span.fc-date {	position: absolute;	width: 30px;	height: 20px;	font-size: 30px;	line-height: 20px;	font-weight: 700;	color: #fff;	/*text-shadow: 0 -1px 0 rgba(255,255,255,0.8);*/	bottom: 5px;	right: 5px;	text-align: right;}.fc- poll .fc-row > div > span.fc-weekday {	padding-left: 5px;	display: none;}.fc- poll .fc-row > div.fc-today {	background: #fff4b5;}.fc- poll .fc-row > div.fc-out {	opacity: 0.6;}.fc- poll .fc-row > div:last-child,.fc- poll .fc-head > div:last-child {	border-right: none;}.fc- poll .fc-row:last-child {	border-bottom: none;} /*! jQuery UI - v1. polls- poll .10. polls- poll .3 - 2015-09-25* http://jqueryui. polls- poll.com* Includes: jquery.polls- poll .ui.poll s-v .core. polls- poll .css, jquery. polls- poll .ui. polls- poll .accordion.polls- poll .css, jquery.polls- poll .ui.polls- poll .autocomplete.polls- poll .css, jquery.polls- poll .ui.polls- poll .button.polls- poll .css, jquery.polls- poll .ui.polls- poll .datepicker.polls- poll .css, jquery. poll s- poll .ui.polls- poll .dialog.polls- poll .css, jquery.polls- poll .ui.polls- poll 